...
execute as @e[type=#arrows,tag=barinade.arrow] at @s run function desertscourge:items/barinade/arrow/tick

execute as @e[type=item_display,tag=worm.tooth.proj] at @s run function desertscourge:items/worm_tooth/tick_projectile
