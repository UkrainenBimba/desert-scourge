...
attribute @s generic.knockback_resistance modifier add player_motion:disable_knockback_resistance -1 add_multiplied_total
...
attribute @s generic.knockback_resistance modifier remove player_motion:disable_knockback_resistance
